...
<div id="page-wrapper">
	...
	echo '<div class="col-sm-12 col-md-12 well" id="content">';
				   echo ' <h3><b>Valider Les Reservations:</b></h3><br/>';
	$stmt1->execute();
	while($version = $stmt1->fetch()){
	if($version["etat"]=='pendu'){
		echo '<form action="Val-Ann.php" method="get">
		...
		</div><button type="submit" class="btn" name="btn">Valider</button>
		      <button type="submit" class="btn" name="btn1">Annuler</button>
